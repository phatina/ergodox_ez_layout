...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(
        ...
        KC_LCTL,   KC_CAPSLOCK, KC_TRANSPARENT, KC_LGUI, KC_LALT,                     // 5

        KC_TRANSPARENT,  KC_INSERT,          // 2
        KC_HOME,                             // 1
        LT(2, KC_SPACE), KC_BSPACE, KC_END,  // 3
  ...
  [1] = LAYOUT_ergodox(
        ...
        KC_TRANSPARENT, VIM_QUIT,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,   KC_TRANSPARENT,
        KC_TRANSPARENT, KC_TRANSPARENT, VIM_WRITE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        ...
        KC_TRANSPARENT,    KC_TRANSPARENT,  KC_LPRN,        KC_RPRN,        VIM_FUZZY_OPEN, KC_TRANSPARENT, KC_F12,
        KC_TRANSPARENT,    KC_LCBR,         KC_RCBR,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
        KC_RCBR,           KC_TRANSPARENT,  KC_LBRC,        KC_RBRC,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [2] = LAYOUT_ergodox(
        /* left hand */
        KC_GRAVE,       KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,            KC_TRANSPARENT,
        KC_TRANSPARENT, VIM_QUIT,       VIM_WRITE,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,   KC_TRANSPARENT,
